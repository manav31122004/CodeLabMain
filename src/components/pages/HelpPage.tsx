...
export const HelpPage = () => {
  ...
  return (
    <div className="container mx-auto my-auto px-4 py-4 max-w-full min-h-[85vh] overflow-auto ">
      <div className="space-y-8">
        {/* Hero Section */}
        <div className="text-center">
          <h1 className="text-4xl font-extrabold mb-6 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-800 to-blue-500 dark:from-blue-400 dark:to-blue-300">Welcome to CodeLab Help Center</h1>
